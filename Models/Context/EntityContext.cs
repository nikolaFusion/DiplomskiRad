    ...
    public class EntityContext : DbContext
    {
        ...
        public static void InsertDataInTable(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TravelCompany>().HasData(new TravelCompany { TravelCompanyID = 1, Name = "Expedia Group", ImageUrl = "https://i.pinimg.com/originals/36/60/eb/3660eb409de95cf3b7845fbd529672d5.jpg" },
                                                         new TravelCompany { TravelCompanyID = 2, Name = "American Express Global Business Travel", ImageUrl = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSYbSLMzprI55Yo49K4whp-bihwZHOEQ3WZqQ&usqp=CAU" },
            ...
            modelBuilder.Entity<Arrangement>().HasData(new Arrangement { ArrangementID = 21, TravelCompanyID = 1, TravelPlaceID = 15, DateStart = new DateTime(2022, 9, 19, 12, 0, 0), DateEnd = new DateTime(2022, 9, 21, 12, 0, 0), Price = 223.22, SeatsInArrangement = 10, OnlyAirplaneTicket = false },
